                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Form Edit News</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title"
                                                ...
                                                placeholder="Enter title news" value="{{ old('title', $news->title) }}"
                                                required />
                                            @error('title')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug"
                                                ...
                                                value="{{ old('slug', $news->slug) }}" readonly required />
                                            @error('slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="author_choice" name="author_choice" required>
                                                @foreach ($choices as $key => $choice)
                                                    @if (old('author_choice', $news->author_choice) == $key)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="60" name="reading_time"
                                                ...
                                                id="time" value="{{ old('reading_time', $news->reading_time) }}"
                                                required />
                                            @error('reading_time')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="ckeditor" id="body" name="body" value="{{ old('body', $news->body) }}" required>
                                                {{ old('body', $news->body) }}
                                            </textarea>
                                            @error('title')
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status_news" name="status_news" required>
                                                @foreach ($status as $key => $names)
                                                    @if (old('status_news', $news->status_news) == $key)
